...
Variables in Python serve as a way to label and store values for later use.
For example, to define a variable named x and assign it the value 10,
you can use the = symbol like this:
